...
class DownloadHelper:
    def __init__(
        self, logger: logging.Logger = logging.getLogger(name="DownloadHelper")
    ) -> None:
    ...
    def delete_file_folder(self, file_or_folder: str) -> bool:
        ...
        if os.path.exists(file_or_folder):
            ...
            self._logger.info(
                "File or folder does not exist: {}. Skipping.".format(file_or_folder)
            )
            return False

    def download_zip_and_unzip(
        self,
        url: str,
        folder: str,
        data_dir: str = "../data",
